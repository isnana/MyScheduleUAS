...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String NOTE_ID = "com.example.acer.myapplication.ID";
    public static final String NOTE_TITLE = "com.example.acer.myapplication.TITLE";
    public static final String NOTE_NOTE = "com.example.acer.myapplication.NOTE";
    public static final String NOTE_CATEGORY = "com.example.acer.myapplication.CATEGORY";

    //KEY FOR GETTING THE PASSING THE FRAGMENT PROPERLY
    public static final String FRAGMENT_TO_LAUNCH = "com.example.acer.myapplication.FRAGMENT_TO_LAUNCH";
